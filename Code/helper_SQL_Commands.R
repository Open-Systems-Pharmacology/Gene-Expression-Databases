...
VIEW <- c(
  "CREATE VIEW QRY_CONTAINER_TISSUE AS SELECT TAB_CONTAINER_TISSUE.CONTAINER as CONTAINER, TAB_CONTAINER_TISSUE.TISSUE as TISSUE FROM TAB_CONTAINER_TISSUE",
