...
# Classify genes by family using Gene.ID patterns (used as fallback in Scenario 2)
# In Scenario 1 (OSP DB available), classification uses gene_name from the joined OSP data
