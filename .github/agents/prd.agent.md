...
You will create a file named `prd.md` in the `.github` location. Ask the user to confirm or provide an alternative.
...
After generating the PRD, I will ask if you want to proceed with creating GitHub issues for the user stories. If you